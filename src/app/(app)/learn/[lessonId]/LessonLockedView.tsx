...
export function LessonLockedView({ lessonTitle, moduleTitle, objective, lessonId }: Props) {
  return (
    <div className="flex h-screen items-center justify-center bg-cq-bg px-6 text-cq-text-primary">
      <div className="w-full max-w-2xl rounded-3xl border border-cq-border bg-cq-bg-elevated p-8 text-center shadow-panel">
        ...
        <div className="mt-6 rounded-2xl border border-cq-cyan/40 bg-cq-bg-panel p-5 text-left">
          <p className="text-xs uppercase tracking-[0.3em] text-cq-text-secondary">
            What you will learn
          </p>
          <p className="mt-2 text-sm text-white">
            {objective || "Byte has a brilliant new quest waiting for you!"}
          </p>
          <p className="mt-3 text-sm text-cq-text-secondary">
            You&apos;ve mastered Module 1 - the adventure continues with Spark.
          </p>
          <p className="mt-3 text-sm text-cq-text-secondary">
            Byte says: &quot;I can&apos;t wait to teach you this one!&quot;
          </p>
        </div>
        ...
        <div className="mt-6 flex flex-col gap-3 sm:flex-row sm:justify-center">
          <Link
            ...
            className="inline-flex items-center justify-center rounded-full bg-cq-cyan px-6 py-3 text-sm font-semibold text-black shadow-glow-cyan"
          >
            Unlock this lesson
          </Link>
          <Link
